/**
 * Official English introduction copy for /introduction.
...
export const INTRODUCTION_HERO = {
  ...
  subtitle:
    "Uniting education, policy, industry, civil society, and youth on one vibrant platform to reimagine Bhartiya education and shape global learning.",
} as const;
