...
/** Send confirmation email asynchronously after artifacts exist. */
...
/** Generate artifacts synchronously, then queue the confirmation email. */
export async function runRegistrationPostSubmit(input: RegistrationPostSubmitInput) {
  ...
  queueRegistrationConfirmationEmail(input, artifacts);
}
