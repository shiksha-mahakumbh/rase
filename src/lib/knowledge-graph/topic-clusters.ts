...
export const TOPIC_CLUSTERS: TopicCluster[] = [
  ...
  { id: "conf-mahakumbh", pillarId: "conferences", label: "Shiksha Mahakumbh", description: "Mahakumbh editions" },
  { id: "conf-kumbh", pillarId: "conferences", label: "Shiksha Kumbh", description: "Kumbh editions" },
