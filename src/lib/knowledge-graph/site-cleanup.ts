...
const CURATED_BY_PATH: Record<string, InternalLinkSuggestion[]> = {
  ...
  "/past_event/shiksha-mahakumbh-1.0": [
    { href: "/past_event/shiksha-mahakumbh-2.0", label: "SMK 2.0 — NIT Kurukshetra", reason: "curated", weight: 88 },
    { href: "/proceeding2", label: "Proceedings Vol. II", reason: "curated", weight: 92 },
    { href: "/media/shiksha-mahakumbh/1.0/digital", label: "Digital Media 1.0", reason: "curated", weight: 86 },
    { href: "/downloads", label: "Edition Brochures", reason: "curated", weight: 84 },
    { href: "/committee/Shiksha%20Mahakumbh%201.0", label: "Organising Committee", reason: "curated", weight: 82 },
    { href: "/upcoming-events", label: "Shiksha Mahakumbh 6.0", reason: "curated", weight: 80 },
  ],
  "/past_event/shiksha-mahakumbh-2.0": [
    { href: "/past_event/shiksha-mahakumbh-1.0", label: "SMK 1.0 — NIT Jalandhar", reason: "curated", weight: 86 },
    { href: "/past_event/shiksha-mahakumbh-3.0", label: "SMK 3.0 — NIT Srinagar", reason: "curated", weight: 88 },
    { href: "/proceeding1", label: "Proceedings Vol. I", reason: "curated", weight: 92 },
    { href: "/media/shiksha-mahakumbh/2.0/digital", label: "Digital Media 2.0", reason: "curated", weight: 84 },
    { href: "/downloads", label: "Edition Brochures", reason: "curated", weight: 82 },
    { href: "/registration", label: "Register for SMK 6.0", reason: "curated", weight: 80 },
  ],
  "/past_event/shiksha-mahakumbh-3.0": [
    { href: "/past_event/shiksha-mahakumbh-2.0", label: "SMK 2.0 — NIT Kurukshetra", reason: "curated", weight: 86 },
    { href: "/past_event/shiksha-mahakumbh-4.0", label: "SMK 4.0 — Kurukshetra University", reason: "curated", weight: 88 },
    { href: "/proceeding3", label: "Proceedings Vol. III", reason: "curated", weight: 92 },
    { href: "/media/shiksha-mahakumbh/3.0/digital", label: "Digital Media 3.0", reason: "curated", weight: 84 },
    { href: "/gallery", label: "Gallery", reason: "curated", weight: 82 },
    { href: "/media-center", label: "Media Centre", reason: "curated", weight: 80 },
  ],
  "/past_event/shiksha-mahakumbh-4.0": [
    { href: "/past_event/shiksha-mahakumbh-3.0", label: "SMK 3.0 — NIT Srinagar", reason: "curated", weight: 86 },
    { href: "/past_event/shiksha-mahakumbh-5.0", label: "SMK 5.0 — NIPER Mohali", reason: "curated", weight: 88 },
    { href: "/proceedings", label: "Proceedings Hub", reason: "curated", weight: 90 },
    { href: "/publications/souvenir-abstracts-mtc#smk-4.0", label: "MTC Souvenir Abstracts", reason: "curated", weight: 88 },
    { href: "/media/shiksha-mahakumbh/4.0/digital", label: "Digital Media 4.0", reason: "curated", weight: 84 },
    { href: "/best-wishes", label: "Best Wishes", reason: "curated", weight: 82 },
  ],
  "/past_event/shiksha-mahakumbh-5.0": [
    { href: "/past_event/shiksha-mahakumbh-4.0", label: "SMK 4.0 — Kurukshetra University", reason: "curated", weight: 86 },
    { href: "/upcoming-events", label: "Shiksha Mahakumbh 6.0", reason: "curated", weight: 92 },
    { href: "/registration", label: "Register for SMK 6.0", reason: "curated", weight: 90 },
    { href: "/media/shiksha-mahakumbh/5.0/digital", label: "Digital Media 5.0", reason: "curated", weight: 88 },
    { href: "/media/shiksha-mahakumbh/5.0/print", label: "Print Media 5.0", reason: "curated", weight: 86 },
