...
export const AUTHORITY_MAP: AuthorityEntry[] = [
  ...
  { path: "/VibhagRoute/AcademicCouncil24", tier: "primary", pillarId: "higher-education", weight: 85 },
  { path: "/academiccouncil", tier: "secondary", pillarId: "higher-education", weight: 80 },
  { path: "/proceedings", tier: "secondary", pillarId: "publications", weight: 75 },
  { path: "/media", tier: "secondary", pillarId: "media", weight: 70 },
  { path: "/Press_Release", tier: "supporting", pillarId: "media", weight: 65 },
