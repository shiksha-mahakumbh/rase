          ...
          sections: [
            {
              ...
              content: [
                ...
                "Categorizing these papers into three distinct themes â€“ Skill & Startup, Entrepreneurship, and Best Practices & Innovations â€“ provides a comprehensive lens to examine the multifaceted impact of academic-driven startups on our economy.",
            ...
            },
            {
              ...
              papers: [
                ...
                {
                  id: "G1-P10",
                  title: "Implications and Insights: Artificial Intelligence and Machine Learningâ€™s Revolution in Academic Startups",
                  authors: [
                ...
                },
                {
                  ...
                  abstract: "India, known for its strong ancient education system of Gurukuls and renowned Universities such as Nalanda and Takshshila, has traditionally prioritised higher education. These institutions have remained an important part of the countryâ€˜s fabric, instilling in pupilsâ€˜ specific skills and knowledge that have fashioned them into pillars of society and contributors to the countryâ€˜s economic growth. However, according to industry observers, India has a lot of potential but has not been able to tap all of that into some ground-breaking and pioneering products. Many start-ups that could have blossomed into massive corporations died an untimely death. One of the many reasons why the start-up revolution has been delayed in India is the lack of an ecosystem for entrepreneurship culture. Unfortunately, the countryâ€˜s schools, colleges, and universities have been unable to give students an environment that fosters and encourages creativity, ideation, and invention. This paper aims to study the need for the development of Start-up culture in schools. While studying the various factors, the authors have tried to develop a framework for the ecosystem required to develop the said culture in schools.",
                  keywords: [
                    "Entrepreneurship",
                    "Ecosystem",
                    "Education",
            ...
            },
            {
              ...
              contact: [],
              abstract: "This historic event depicts the valour and sacrifice of our freedom fighters. The University has established a multi-disciplinary Centre of Excellence for Research on Saraswati River (CERSR). Efforts made by the University in preserving and showcasing the cultural heritage of Haryana in the â€˜Dharoharâ€™ museum have received an overwhelming response, with more than 26.5 lakh visitors. Delegates from 110 different countries have visited and admired the museum; research scholars have been regularly consulting various items/resources available in the museum. The recently established museum on â€˜First War of Independence 1857â€™ has earned appreciation from visitors and has been spreading the waves of patriotism. The â€˜Ratnawali Festivalâ€™, a state-level mega cultural fest held on the occasion of Haryana statehood day, has grown into a â€˜Mahakumbh of Haryana Sanskriti,â€™ which has not only entrenched youth into Haryanvi culture but also attracted numerous elders from adjoining towns/villages. The practice of preservation of Indian Heritage and Indic values-based holistic education meets one of the objectives of NEP-2020.",
