...
const Proceeding2: React.FC<{ data: Data }> = ({ data }) => {
  if (!data) {
  ...
  return (
    <div className="proceeding-container">
      <h1 className="text-4xl font-bold text-center mb-8">Proceeding 1</h1>
      ...
      {data.sections.map((section, index) => (
        <div key={index} className="section">
          <h3 className="text-2xl font-semibold text-brand-navy mb-4">{section.title}</h3>
            ...
            <div className="papers mt-6">
              ...
              <ul className="space-y-6">
                {section.papers.map((paper) => (
                  <li key={paper.id} className="p-4 bg-brand-surface-warm rounded-lg border border-slate-100">
