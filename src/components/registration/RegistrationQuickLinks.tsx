...
import { REGISTRATION_BREADCRUMBS, REGISTRATION_QUICK_LINKS } from "@/data/registration-hub";
  ...
  return (
    <div className="border-b border-brand-navy/10 bg-white">
      <div className="mx-auto max-w-5xl px-4 py-5 md:px-8">
        <BreadcrumbNav
          items={REGISTRATION_BREADCRUMBS.map((item, index, arr) => ({
            label: item.name,
        ...
        >
          {REGISTRATION_QUICK_LINKS.map((link) =>
