...
import { academicCouncilTracks } from "@/content/academic-council/tracks";
import { academicCouncilConclaves } from "@/content/academic-council/conclaves";
      ...
      <main className="flex-1 p-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm mt-10">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {academicCouncilConclaves.map((c, i) => (
