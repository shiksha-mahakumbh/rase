...
const ShikshaMahakumbhMediaTimeline: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-surface via-white to-brand-surface-warm">
      <ShowcaseHero
        eyebrow="Testimonials & Greetings"
        title="शिक्षा महाकुंभ अभियान – Media Timeline"
        subtitle="Explore the journey of Shiksha Mahakumbh editions through official media and messages."
        accent="emerald"
      />
