...
// Sample data for demonstration. Replace this with your actual data source or fetch method.
        ...
        //   pageStart: ,
          sections: [
...

            {
              ...
              content:
               [
                <b> 1. Vice-Chancellor, Kurukshetra University</b>,
                ...
                <b> 2. Dr. Thakur SKR (Sci/Engr-SF, ISRO & Director, Shiksha Mahakumbh)</b>,
                ...
                <b> 3. Shri Vijay Nadda (Organizing Secretary, Vidya Bharati North Zone)</b>,
                ...
                <b> 4. Shri Virender Garg (Patron, Publicity Department, Shiksha Mahakumbh 2.0)</b>,
                ...
                <b> 5. Dr. Amit Kansal (Coordinator, Publicity Department, Shiksha Mahakumbh 2.0)</b>,
...

            {
              ...
              content:
               [
                ...
                <b> Vice-Chancellors and Directors' Conclave</b>,
                "Scientists' Conclave",
                "YouTubers' Conclave                ",
                "Principals' Conclave                ",
                "Media Conclave",
 
                <b>Entrepreneurs/Administrative Officers' Conclave                </b>,
...

            {
              ...
              content:
               [
                <ul key="contact-list">
      <li key="contact-1">
        <a href="tel:+917903431900" style={{ color: 'blue', textDecoration: 'none' }}>
          Call: +91 7903431900
        </a> ,
        <a 
      ...
      <li key="contact-2">
        <a href="tel:+918360990494" style={{ color: 'blue', textDecoration: 'none' }}>
          Call: +91 8360990494
        </a>, 
        <a 
      ...
      <li key="contact-3">
        <a href="tel:+919416362401" style={{ color: 'blue', textDecoration: 'none' }}>
          Call: +91 9416362401
        </a> ,
        <a 
